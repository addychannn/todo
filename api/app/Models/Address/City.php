...
{
    use AddressModelTrait, LikeToggleTrait;
    ...
    protected static $sync_fields = [
        "name", "oldName", "isCapital", "provinceCode",
    ...
    protected static function sync_fix(){
        ...
        $name_fix = self::where('name', self::LikeToggle(), '%City%')->whereNotIn('code', $skip)->get();
        ...
        $cities = self::where('type_id', 1)->whereNotIn('code', $skip)->get();
