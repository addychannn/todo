    ...
    <div class="flex flex-col max-w-sm mx-auto gap-4">
      ...
      <div  v-for="(task, index) in form.task_name" :key="index" class="flex flex-row gap-2 justify-between w-full">
        ...
        <div class="w-full">
            <button
            @click="addTask" 
            type="button" class="px-3 py-2 w-full text-md font-medium text-center inline-flex items-center text-black border-2 border-dashed  border-dark/25 rounded-md hover:bg-slate-100">
